...
namespace CoreWCF.Channels
{
    public class AzureQueueStorageTransportPump : QueueTransportPump
    {
        ...
        public AzureQueueStorageTransportPump(IServiceProvider serviceProvider, IServiceDispatcher serviceDispatcher)
        {
            _baseAddress = serviceDispatcher.BaseAddress;
            _logger = serviceProvider.GetRequiredService<ILogger<AzureQueueStorageTransportPump>>();
        }
